namespace FxFixGateway.Domain.Interfaces
{
    ...
    public interface IMarketDataSubscriber
    {
        ...
        /// <summary>Skickar fullständig MarketDataRequest (35=V) med explicita symboler (probe).</summary>
        void SendMarketDataRequestProbe(string sessionKey, IEnumerable<string> symbols);
    }
}